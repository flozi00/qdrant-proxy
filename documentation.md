...
| Document | Contents |
|----------|----------|
| [Overview & Index](docs/README.md) | Project overview, design decisions, documentation index |
| [Architecture & File Tree](docs/architecture.md) | Code structure, module map, collection naming |
| [Search Pipeline](docs/search-pipeline.md) | Embedding strategy, hybrid search flow, Docling integration |
